...
bool FBlueprintSubsystemModule::HandleBlueprintSubsystemSettingsSaved()
{
	...
	if (ISettingsModule* SettingsModule = FModuleManager::GetModulePtr<ISettingsModule>("Settings"))
	{
		...
		if (const auto SettingsSection = SettingsModule->RegisterSettings("Project", "Game", "Subsystems",
		                                                                  ...
		                                                                  NSLOCTEXT("BlueprintableSubsystem",
			                                                                  ...
			                                                                  "Configure Blueprint Subsystems"),
		                                                                  GetMutableDefault<
			                                                                  UBlueprintSubsystemSettings>());
			SettingsSection.IsValid())
		{
			SettingsSection->OnModified().BindRaw(
				this, &FBlueprintSubsystemModule::HandleBlueprintSubsystemSettingsSaved);
...
IMPLEMENT_MODULE(FBlueprintSubsystemModule, BlueprintableSubsystem)
